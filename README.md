...
По умолчанию скачивает только необходимые файлы (`docker-compose.yml`, конфиг HAProxy) и тянет готовые образы с [Docker Hub](https://hub.docker.com/r/dc319/rdpproxy) — **git и весь исходный код не нужны**.
